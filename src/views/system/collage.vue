<template>
    <div>
        <TableSearch :query="query" :options="searchOpt" @toggleAdd='handleToggleAdd'  :toggle="handleBatchDel" :search="handleSearch" :isquery='isquery' :isExport="isExport" :isAdd='isAdd' :isToggle="isToggle" :selectData="selectData"/>
        <div class="container">
            <TableCustom :columns="columns"  :currentPage="currentPage"  @changePage="changePage" :tableData="tableData" :total="pageList.total" :viewFunc="handleView"
                :delFunc="handleDelete" :editFunc="handleEdit" :isSelection='isSelection' @sendMessage="handleSendMessage">
                <!-- <template #toolbarBtn>
...
import { collegeListApi,collegeAddApi,collegeDelApi,collegeAllDelApi} from "../../api/index";
...
const getData = async () => {
  await request
    .get(collegeListApi, { data: pageList })
    .then((response) => {
...
let options = ref<FormOption>({
    ...
    span: 24,
    list: [
        { type: 'input', label: '学院名称', prop: 's_college', required: true },
