    ...
    <div>
        ...
        <div class="container">
            <TableCustom :columns="columns" :tableData="tableData" :total="page.total" :viewFunc="handleView"
                :delFunc="handleDelete" :page-change="changePage" :editFunc="handleEdit" :isSelection='isSelection' @cellData="getCellData" @sendMessage="handleSendMessage">
                <!-- <template #toolbarBtn>
...
let columns = ref([
    ...
    { prop: 'name', label: '用户输入内容' },
    { prop: 'phone', label: 'AI响应内容' },
    { prop: 'role', label: '消息类型' },
    { prop: 'role', label: '上下文ID' },
