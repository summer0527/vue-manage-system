...
let options = ref<FormOption>({
    ...
    span: 24,
    list: [
        { type: 'input', label: '专业名称', prop: 'name', required: true },
        { type: 'select', label: '所属校区', prop: 'name', required: true,opts:[{label:'东校区',value:'1'},{label:'西校区',value:'2'}] },
        { type: 'select', label: '所属学院', prop: 'name', required: true,opts:[{label:'东校区',value:'1'},{label:'西校区',value:'2'}] },
        { type: 'number', label: '学制', prop: 'name', required: true },
        { type: 'textarea', label: '主修课程', prop: 'phone', required: true },
